...
import com.metadisk.cryptomarket.databinding.ViewLineChartBinding
...
object ChartHelper {
    ...
    fun displayHistoricalLineChart(view: ViewLineChartBinding, symbol: String, historyList: List<DoubleArray>) {
